        ...
        >
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 space-y-4" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.20)' }}>
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Cette action est <strong>irréversible</strong>. Votre profil, vos rapports, votre planning et toutes vos données personnelles seront définitivement supprimés.
            </p>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white/80 text-sm font-medium">ChantierPV</span>
            </div>
