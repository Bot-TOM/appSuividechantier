...
export default function AnomaliesChantier() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="max-w-2xl md:max-w-5xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          {selectMode ? (
            <button
              ...
              className="text-sm font-semibold text-gray-500 px-3 py-2 rounded-xl hover:bg-gray-100 transition-colors"
            >
              Annuler
            </button>
          ) : (
      ...
      <main className="max-w-2xl md:max-w-5xl mx-auto px-4 py-5 space-y-4" style={{ paddingBottom: selectMode ? '8rem' : 'max(2rem, env(safe-area-inset-bottom, 1rem))' }}>
      ...
      {selectMode && selectedIds.size > 0 && (
        <div className="fixed bottom-0 left-0 right-0 z-20 bg-white border-t border-gray-100 px-4 py-4 safe-area-bottom"
          ...
          <div className="flex gap-2 max-w-2xl md:max-w-5xl mx-auto">
            <button
              onClick={() => handleBulkStatut('en_cours')}
              className="flex-1 py-3 rounded-xl text-xs font-semibold bg-orange-50 text-orange-700 hover:bg-orange-100 transition-colors"
            >
              En cours
            </button>
            <button
              onClick={() => handleBulkStatut('resolu')}
              className="flex-1 py-3 rounded-xl text-xs font-semibold bg-green-50 text-green-700 hover:bg-green-100 transition-colors"
            >
              Résoudre
            </button>
            <button
              onClick={() => handleBulkStatut('ouvert')}
              className="flex-1 py-3 rounded-xl text-xs font-semibold bg-red-50 text-red-700 hover:bg-red-100 transition-colors"
            >
              Rouvrir
            </button>
            {isManager && (
              <button
                ...
                className="py-3 px-4 rounded-xl text-xs font-semibold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
